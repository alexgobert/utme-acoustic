...
class AcousticDirectivityDriverGUI:
    def __init__(self, master):
        ...
        self.style.configure("TEntry", foreground="white", background="#1c1c1c", font=('Segoe UI', 11))
    ...
    def browse_recording_path(self):
        ...
        self.recording_path_entry.delete(0, tk.END)
        self.recording_path_entry.insert(0, recording_path)
